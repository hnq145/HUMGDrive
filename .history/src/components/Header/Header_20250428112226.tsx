      ...
      <div className="px-6 flex justify-between  items-center py-3">
        <div className="items-center w-[260px] hidden desktopMode:flex">
          <a
            ...
            onClick={() => navigate("/")}
          >
            <img className="w-8" src="https://www.google.com.vn/url?sa=i&url=http%3A%2F%2Fhumg.edu.vn%2Ftin-tuc%2FPages%2Fthong-bao.aspx%3FItemID%3D5728&psig=AOvVaw0UTQsgr8Fqg3XFSNOTc8k0&ust=1745900521612000&source=images&cd=vfe&opi=89978449&ved=0CBQQjRxqFwoTCJiOxbTw-YwDFQAAAAAdAAAAABAE" alt="logo" />
          </a>
        </div>
        {!isSettings && (
