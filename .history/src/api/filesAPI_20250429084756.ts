...
>) => {
  const { searchText, trashMode, mediaMode } = queryKey[1];
...
export const trashMultiAPI = async (items: string[]) => {
...
export const restoreMultiAPI = async (items: string[]) => {
...
export const moveMultiAPI = async (items: string[], parentID: string) => {
...
export const deleteMultiAPI = async (items: string[]) => {
...
export const uploadFileAPI = async (data: FormData, config: AxiosRequestConfig) => {
