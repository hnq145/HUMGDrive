...
const DataForm = memo(
  ({ scrollDivRef }: { scrollDivRef: React.RefObject<HTMLDivElement> }) => {
    ...
    }, [isLoading, navigationMap, location.pathname, dispatch, scrollDivRef]);
    ...
    return (
      <div
        className={classNames(
          "w-full px-2.5 desktopMode:px-10 py-6 overflow-y-scroll mt-5",
          {
      ...
      >
        ...
        {/* @ts-expect-error: sentinelRef may not match expected type for ref */}
